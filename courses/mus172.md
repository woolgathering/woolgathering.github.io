...
<br/>
_Homework 1_: Take the granular synth we've been making (see the link to Thursday above) and add randomness to:
- grain trigger
- grain length
- offset
This means that each grain should have a random onset time (trigger), length, and offset in the file. Provide controls for these.
