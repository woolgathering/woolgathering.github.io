...
__Homework 2__: Create a drum machine that contains the following instruments: hi-hat, snare, kick, and at least one tom. Recreate "The Funky Drummer" beat, with tempo control. EXTRA: recreate the open-close hi-hat sound in "The Funky Drummer" (+2). Recreate another iconic beat or make one of your own (+1).
